        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          ...
          <div className="flex items-center justify-between gap-3 py-3">
            ...
            <div className="flex items-center gap-2">
              <button
                className="btn-soft shrink-0 px-3 py-1.5 text-xs font-bold text-brand-700 bg-brand-500/10 hover:bg-brand-500/20"
                onClick={() => {
                  setInviteError(null);
                  setInviteEmail("");
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 backdrop-blur-sm animate-fade-in">
          <div className="card w-full max-w-md animate-scale-in p-6">
            ...
            <p className="mt-1 text-xs text-ink-500">
              Enter an email address to add them to this group. Existing Settl users will be added immediately.
            </p>
            ...
            <div className="mt-4 space-y-3">
              ...
              {inviteError && (
                <div className="rounded-xl bg-rose-500/15 px-3 py-2 text-xs font-semibold text-rose-600">
                  {inviteError}
                </div>
              )}
              ...
              <div className="flex gap-2 pt-2">
                <button
                  className="btn-soft flex-1 py-2.5 text-sm"
                  onClick={() => setInviteModalOpen(false)}
                >
                  Cancel
                </button>
